...
class AUTO_FSM:
    def __init__(self):
        ...
        self.yaml_name = str(rospy.get_param('/goal_yaml_filename','/goal.yaml')) 
        ...
        self.game_shoot_rest_number = 0 #self.set_shoot_number_max
    ...
    def thread_tf(self):
        ...
        while not rospy.is_shutdown():
            ...
            try:
                ...
                self.gimbal_yaw_current = tf_rot[2]
                    #print('enemy tf get')
